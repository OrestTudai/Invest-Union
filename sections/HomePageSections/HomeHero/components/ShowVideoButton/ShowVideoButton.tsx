...
export const ShowVideoButton = ({ buttonText }: Props) => {
  ...
  return (
    <>
      ...
      >
        <span className="block rotate-[-90deg] text-nowrap opacity-70">
          {buttonText}
        </span>
      ...
      {showVideo &&
        createPortal(
          <div
            ...
            className="fixed inset-0 z-[99999] flex items-center justify-center bg-[#3a3a3a]/90"
          >
            <div
