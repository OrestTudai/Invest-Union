...
export const AboutUsHero = () => {
  return (
    <section
      className="flex flex-col items-center pt-[260px] pb-12 px-4 bg-cover bg-center md:px-10 md:pt-[520px] md:pb-[100px]"
    ...
    >
      ...
      <Image
        className="mt-[156px] md:mt-[262px] md:w-[86px] md:h-[72px]"
        src={ArrowsButton}
